...
function ServiceCard({ service }: ServiceCardProps) {
  ...
  return (
    <article className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-md hover:-translate-y-1 transition-all duration-200 flex flex-col gap-4">
      <div>
        <span className="inline-block px-3 py-1 text-xs font-semibold bg-blue-50 text-fia-primary rounded-full mb-3">
          {service.level}
        </span>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="mt-4 text-gray-500 max-w-xl mx-auto">
            Cada clase está adaptada a tu nivel, ritmo y objetivos. Sin fórmulas genéricas.
          </p>
        </div>
